...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/juechufengshenger@126.com/FFReformerKeysKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'juechufengshenger@126.com' => 'xiaobing.tang@zhaopin.com.cn' }
  s.source           = { :git => 'https://github.com/juechufengshenger@126.com/FFReformerKeysKit.git', :tag => s.version.to_s }
